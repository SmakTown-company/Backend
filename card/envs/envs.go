...
func LoadEnvs() error {
	...
	ServerEnvs.MONGO_INITDB_ROOT_USERNAME_CARD = os.Getenv("MONGO_INITDB_ROOT_USERNAME_CARD")
	ServerEnvs.MONGO_INITDB_ROOT_PASSWORD_CARD = os.Getenv("MONGO_INITDB_ROOT_PASSWORD_CARD")
	ServerEnvs.MONGO_INITDB_PORT_CARD = os.Getenv("MONGO_INITDB_PORT_CARD")
	ServerEnvs.MONGO_INITDB_HOST_CARD = os.Getenv("MONGO_INITDB_HOST_CARD")
