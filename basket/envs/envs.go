...
func LoadEnvs() error {
	...
	ServerEnvs.MONGO_INITDB_ROOT_USERNAME_BASKET = os.Getenv("MONGO_INITDB_ROOT_USERNAME_BASKET")
	ServerEnvs.MONGO_INITDB_ROOT_PASSWORD_BASKET = os.Getenv("MONGO_INITDB_ROOT_PASSWORD_BASKET")
	ServerEnvs.MONGO_INITDB_PORT_BASKET = os.Getenv("MONGO_INITDB_PORT_BASKET")
	ServerEnvs.MONGO_INITDB_HOST_BASKET = os.Getenv("MONGO_INITDB_HOST_BASKET")
